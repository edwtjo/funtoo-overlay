...
src_prepare() {
	...
	# Backport of changes suggested in Gentoo bug #374579 for dev-lang/python-2.7.2-r1
...
src_install() {
	...
	# Backport of the changes suggested in Gentoo bug #374579 for dev-lang/python-2.7.2-r1
...
pkg_postinst() {
	...
	if [[ "${python_updater_warning}" == "1" ]]; then
		...
		ewarn "'python-updater' to rebuild Python modules."
		ewarn
		ewarn "\e[1;31m************************************************************************\e[0m"
		ewarn
